    ...
    <section className="py-20 px-6 bg-slate-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {['ISO 9001', 'ISO 14001', 'OHSAS 18001'].map((cert, i) => (
            <div key={i} className="p-6 bg-white rounded-xl border border-slate-200 hover:shadow-lg transition text-center">
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-2">{cert}</h3>
              <p className="text-sm text-slate-600">Certified quality standard</p>
            </div>
          ))}
        </div>
      </div>
