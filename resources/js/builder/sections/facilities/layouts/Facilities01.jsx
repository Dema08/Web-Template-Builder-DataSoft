    ...
    <section className="py-20 px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {['Library', 'Laboratory', 'Sports Complex'].map((facility, i) => (
            <div key={i} className="p-6 bg-slate-50 rounded-xl border border-slate-200 hover:shadow-lg transition">
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-2">{facility}</h3>
              <p className="text-sm text-slate-600">Modern {facility.toLowerCase()} facility</p>
            </div>
          ))}
        </div>
      </div>
