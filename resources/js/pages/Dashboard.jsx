...
import { useDashboard, useWebsite } from '@hooks';
        ...
        <div className="p-6 sm:p-8 max-w-7xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">Welcome back. Here's what's happening with your projects today.</p>
                </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-200/80 shadow-xs overflow-hidden">
                <div className="p-6 flex items-center justify-between border-b border-slate-100">
                    <h2 className="text-lg font-extrabold text-slate-900">Recent Websites</h2>
                            ...
                            {mockWebsites.map((site) => (
                                <tr key={site.id} className="hover:bg-slate-50/80 transition">
                                    <td className="py-4 px-6">
                                        <div className="flex items-center gap-3">
                                            <div className={`h-9 w-9 rounded-xl ${site.iconColor} flex items-center justify-center font-bold text-xs shadow-xs`}>
                                    ...
                                    <td className="py-4 px-6">
                                        <div className="flex items-center gap-2.5">
                                            ...
                                            <span className="font-semibold text-slate-700">{site.owner}</span>
                                        </div>
                                    </td>
                                    <td className="py-4 px-6">
                                        <span
                                    ...
                                    <td className="py-4 px-6 font-medium text-slate-500">{site.lastModified}</td>
                                    <td className="py-4 px-6 font-bold text-slate-700">{site.subscribers}</td>
                                    <td className="py-4 px-6 text-right">
                                        <Link
                                            to={ROUTES.BUILDER}
                                            className="p-1.5 text-slate-400 hover:text-blue-600 rounded-lg hover:bg-blue-50 inline-flex items-center transition"
                                            title="Open Builder"
                                        >
                ...
                <div className="p-4 px-6 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
                    <p className="font-medium">Showing 3 of 12 websites</p>

                    <div className="flex items-center gap-1.5">
                        <button type="button" className="p-1.5 border border-slate-200 rounded-lg text-slate-400 hover:text-slate-700 hover:bg-slate-50 transition">
