        ...
        <div className="p-5 border-b border-slate-100">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-600/20 focus:border-indigo-600"
            />
          </div>
        </div>
            ...
            <table className="w-full">
              <thead className="bg-slate-50 border-b border-slate-200">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-xs font-bold text-slate-600 uppercase tracking-wider">Slug</th>
                  <th className="px-4 py-3 text-left text-xs font-bold text-slate-600 uppercase tracking-wider">Description</th>
                  <th className="px-4 py-3 text-left text-xs font-bold text-slate-600 uppercase tracking-wider">Icon</th>
                    ...
                    <tr key={cat.id} className="hover:bg-slate-50/80 transition">
                      <td className="px-4 py-4 whitespace-nowrap">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-sm font-bold text-slate-700 w-6 text-center">{cat.sort_order}</span>
                        </div>
                      </td>
                      ...
                      <td className="px-4 py-4">
                        <code className="text-xs bg-slate-100 px-2 py-1 rounded text-slate-700 font-mono">{cat.slug}</code>
                      </td>
                      <td className="px-4 py-4">
                        <p className="text-sm text-slate-600 max-w-xs truncate">{cat.description || '-'}</p>
                      </td>
                      <td className="px-4 py-4 text-sm text-slate-600">{cat.icon || '-'}</td>
                      <td className="px-4 py-4">
                        <div className="flex items-center gap-2">
                          <div
                            ...
                            style={{ backgroundColor: cat.color || '#6366f1' }}
                          />
                          <span className="text-sm text-slate-600 font-mono">{cat.color || 'default'}</span>
                        </div>
                      </td>
                          ...
                          <div className="border-t border-slate-200 bg-slate-50/50">
                            <div className="p-4">
                              <div className="flex items-center justify-between mb-3">
                                <h4 className="text-sm font-bold text-slate-700">Templates in {cat.name}</h4>
                                <button
                              ...
                              {templates.length === 0 ? (
                                <p className="text-xs text-slate-500 text-center py-4">No templates yet. Add your first template.</p>
                              ) : (
                                <div className="space-y-2">
                                  {templates.map((template) => (
                                    <div key={template.id} className="bg-white border border-slate-200 rounded-lg p-3 flex items-center justify-between">
                                      <div>
                                        <p className="text-sm font-bold text-slate-900">{template.name}</p>
                                        <p className="text-xs text-slate-500">Slug: {template.slug} • Usage: {template.usage_count}x</p>
                                      </div>
                                      <div className="flex items-center gap-2">
                                        <button
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-600/20 focus:border-indigo-600"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-600/20 focus:border-indigo-600 font-mono"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-slate-700 mb-1.5">Icon (emoji or text)</label>
                  <input
                    type="text"
                    placeholder="e.g. 🏢"
                    value={formData.icon}
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-700 mb-1.5">Color (hex)</label>
                  <div className="flex gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData({ ...formData, color: e.target.value })}
                      className="flex-1 px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-600/20 focus:border-indigo-600 font-mono"
                    />
                  </div>
                </div>
              </div>
