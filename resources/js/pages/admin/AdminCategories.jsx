...
import { Layers, Plus, Trash2, Edit2, Shield, Search } from 'lucide-react';
        ...
        <div className="p-6 sm:p-8 max-w-7xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <button
                    ...
                    className="flex items-center justify-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl text-sm shadow-md transition"
                >
                        ...
                        <div key={cat.id} className="p-4 sm:px-6 flex items-center justify-between hover:bg-slate-50/80 transition">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-slate-400">Slug: <span className="font-mono text-slate-600">{cat.slug}</span> • {cat.count} Templates</p>
                                </div>
                            </div>
                    ...
                    <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl space-y-4">
                        ...
                        <form onSubmit={handleAdd} className="space-y-4">
                            ...
                            <div className="flex justify-end gap-2 pt-2">
                                <button type="button" onClick={() => setIsAddOpen(false)} className="px-4 py-2 text-xs font-bold text-slate-600">Cancel</button>
                                <button type="submit" className="px-5 py-2 text-xs font-bold bg-blue-600 text-white rounded-xl">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
